...
const Testimonials = () => {
  return (
    <div className="pt-12">
      <div className="flex flex-col items-center px-10 md:px-28 pb-16">
        <div className="text-2xl lg:text-3xl pt-6 font-bold tracking-tighter text-center">
          نظرات کاربران ما
        </div>
      </div>
